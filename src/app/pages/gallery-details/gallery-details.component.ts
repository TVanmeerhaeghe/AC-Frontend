...
export class GalleryDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.paramMap
      ...
      .subscribe(({ cats, prods, productSlug }) => {
        ...
        this.selectedImageUrl = found.imageUrls?.[0] || found.imageUrl || null;

        this.api.getCategoryProducts(found.category_id).subscribe((rp) => {
  ...
  onReserve(): void {
    ...
    this.router.navigate(['/galerie', 'contact'], {
